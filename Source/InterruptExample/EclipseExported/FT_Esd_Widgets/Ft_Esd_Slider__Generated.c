...
Comment :
Introduction:
This widget draws a slider.
CMD_SLIDER is used internally.
...
void Ft_Esd_Slider_CoCmd(Ft_Esd_Slider *context, ft_uint16_t, ft_uint16_t, uint16_t);
...
void *Ft_Esd_Slider__Create__ESD()
{
	...
	{
		eve_printf_debug("Out of memory (Ft_Esd_Slider__Create__ESD)");
	}
	return context;
}
