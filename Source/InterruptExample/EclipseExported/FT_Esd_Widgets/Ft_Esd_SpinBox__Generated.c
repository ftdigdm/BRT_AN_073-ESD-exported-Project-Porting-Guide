...
void Ft_Esd_SpinBox_Update(Ft_Esd_SpinBox *context)
{
	...
	if (context->Watch_Variables__0 != watched__0)
	{
		...
		else
		{
			...
			Ft_Esd_Widget_InsertTop((Ft_Esd_Widget *)context_2, (Ft_Esd_Widget *)parent_2);
		}
	}
...
void Ft_Esd_SpinBox_Number_Position_ForwardRender__Signal(void *c)
{
	...
	uint16_t left_6 = OPT_CENTERY;
	uint16_t right_5 = OPT_RIGHTX;
	uint16_t left_5 = left_6 | right_5;
	uint16_t right_6 = OPT_SIGNED;
	uint16_t options = left_5 | right_6;
	int n = context->Value;
...
uint8_t Ft_Esd_SpinBox__Get_Font__ESD(void *context) { return ((Ft_Esd_SpinBox__ESD *)context)->Font; }
void Ft_Esd_SpinBox__Set_Font__ESD(void *context, uint8_t value) { ((Ft_Esd_SpinBox__ESD *)context)->Font = value; }
...
void *Ft_Esd_SpinBox__Create__ESD()
{
	...
	{
		eve_printf_debug("Out of memory (Ft_Esd_SpinBox__Create__ESD)");
	}
	return context;
}
