...
ESD_WIDGET(Ft_Esd_Rectangle, Include = "Ft_Esd_Rectangle.h", Callback, DisplayName = "ESD Rectangle Widget", Category = EsdBasicWidgets, X = 33, Y = 42, Width = 400, Height = 300)
typedef struct
{
	union
	{
	...
	/* corner radius */
	ESD_INPUT(Radius, Type = ft_int32_t, Min = 0, Default = 4)
