...
Comment :
Introduction:
This widget draws a scroll bar.
CMD_SCROLLBAR is used internally.
*/
...
void Ft_Esd_ScrollBar_CoCmd(Ft_Esd_ScrollBar *context, uint16_t, ft_uint16_t, ft_uint16_t, ft_uint16_t);
...
void *Ft_Esd_ScrollBar__Create__ESD()
{
	...
	{
		eve_printf_debug("Out of memory (Ft_Esd_ScrollBar__Create__ESD)");
	}
	return context;
}
