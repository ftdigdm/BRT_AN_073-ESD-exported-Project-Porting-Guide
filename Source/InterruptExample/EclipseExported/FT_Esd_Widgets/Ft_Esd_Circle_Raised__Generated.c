...
Comment :
Introduction:
This widget simply draws a raised circle. Color argument is used to fill itself.
*/

#include "Ft_Esd_Circle_Raised.h"
...
static Ft_Esd_WidgetSlots s_Ft_Esd_Circle_Raised__Slots = {
	(void(*)(void *))Ft_Esd_Widget_Initialize,
	(void(*)(void *))Ft_Esd_Widget_Start,
	(void(*)(void *))Ft_Esd_Widget_Enable,
	(void(*)(void *))Ft_Esd_Widget_Update,
	(void(*)(void *))Ft_Esd_Circle_Raised_Render,
...
void Ft_Esd_Circle_Raised__Initializer(Ft_Esd_Circle_Raised *context)
{
	...
	context->Widget.ClassId = Ft_Esd_Circle_Raised_CLASSID;
	context->Widget.Slots = &s_Ft_Esd_Circle_Raised__Slots;
...
void Ft_Esd_Circle_Raised_Render(Ft_Esd_Circle_Raised *context)
{
	...
	Ft_Esd_Elements_CircleRaised(color, x, y, radius);
...
typedef struct
{
	Ft_Esd_Circle_Raised Instance;
} Ft_Esd_Circle_Raised__ESD;


void *Ft_Esd_Circle_Raised__Create__ESD()
{
	Ft_Esd_Circle_Raised__ESD *context = (Ft_Esd_Circle_Raised__ESD *)malloc(sizeof(Ft_Esd_Circle_Raised__ESD));
	if (context)
	{
		Ft_Esd_Circle_Raised__Initializer(&context->Instance);
		context->Instance.Owner = context;
	}
	else
	{
		eve_printf_debug("Out of memory (Ft_Esd_Circle_Raised__Create__ESD)");
	}
	return context;
}

void Ft_Esd_Circle_Raised__Destroy__ESD(void *context)
{
	free(context);
}

void Ft_Esd_Circle_Raised__Set_Color__ESD(void *context, ft_argb32_t value) { ((Ft_Esd_Circle_Raised__ESD *)context)->Instance.Color = value; }
