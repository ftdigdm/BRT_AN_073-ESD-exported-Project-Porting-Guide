...
ESD_WIDGET(Ft_Esd_CircleLine, Include = "Ft_Esd_CircleLine.h", Callback, DisplayName = "ESD Circle Line", Category = EsdBasicWidgets, X = 14, Y = 12, Width = 252, Height = 261, BackToFront)
typedef struct
{
	union
	{
