...
Comment :
Introduction:
This widget draws a toggle box.
CMD_TOOGLE is used internally.
...
uint8_t Ft_Esd_Toggle_Font__Default(void *context) { return 27; }
...
static uint8_t Ft_Esd_Toggle_Setup_Font__return(Ft_Esd_Toggle *context);

void Ft_Esd_Toggle_Render_CoCmd(Ft_Esd_Toggle *context, ft_uint8_t, ft_int16_t, ft_int16_t, ft_int16_t, ft_int16_t, uint16_t, ft_uint16_t, const ft_char8_t *);
...
void Ft_Esd_Toggle_Render(Ft_Esd_Toggle *context)
{
	...
	uint16_t left_3 = Esd_GetFontHeight(fontInfo);
	...
	uint16_t left_8 = Esd_GetFontHeight(fontInfo_1);
	...
	uint16_t left_12 = Esd_GetFontHeight(fontInfo_2);
	...
	uint16_t left_15 = Esd_GetFontHeight(fontInfo_3);
	...
	uint8_t font = Ft_Esd_Toggle_Setup_Font__return(context);
	uint16_t options = 0;
...
uint8_t Ft_Esd_Toggle_Setup_Font__return(Ft_Esd_Toggle *context)
{
	void *owner = context->Owner;
...
void Ft_Esd_Toggle_Update(Ft_Esd_Toggle *context)
{
	...
	if (if_9)
	{
		...
		{
			uint8_t i_5 = context->Font(owner);
			fontInfo_5 = Esd_GetRomFont(i_5);
		}
		uint16_t left_18 = Esd_GetFontHeight(fontInfo_5);
...
uint8_t Ft_Esd_Toggle__Get_Font__ESD(void *context) { return ((Ft_Esd_Toggle__ESD *)context)->Font; }
void Ft_Esd_Toggle__Set_Font__ESD(void *context, uint8_t value) { ((Ft_Esd_Toggle__ESD *)context)->Font = value; }
...
void *Ft_Esd_Toggle__Create__ESD()
{
	...
	{
		eve_printf_debug("Out of memory (Ft_Esd_Toggle__Create__ESD)");
	}
	return context;
}
