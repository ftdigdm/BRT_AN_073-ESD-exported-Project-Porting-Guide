...
uint8_t Ft_Esd_PushButton__Get_Font__ESD(void *context) { return ((Ft_Esd_PushButton__ESD *)context)->Font; }
void Ft_Esd_PushButton__Set_Font__ESD(void *context, uint8_t value) { ((Ft_Esd_PushButton__ESD *)context)->Font = value; }
...
void *Ft_Esd_PushButton__Create__ESD()
{
	...
	{
		eve_printf_debug("Out of memory (Ft_Esd_PushButton__Create__ESD)");
	}
	return context;
}
