...
ESD_WIDGET(Ft_Esd_PolygonWidget, Include = "Ft_Esd_PolygonWidget.h", Callback, DisplayName = "ESD Polygon Widget", Category = EsdBasicWidgets, X = 202, Y = 105, Width = 250, Height = 250)
typedef struct
{
	union
	{
