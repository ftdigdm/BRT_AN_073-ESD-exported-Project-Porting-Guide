...
Comment :
Introduction:
This widget draws a full RGB color panel.
User can pick any pixel in that panel to choose a color.
*/
...
void *Ft_Esd_ColorPicker__Create__ESD()
{
	...
	{
		eve_printf_debug("Out of memory (Ft_Esd_ColorPicker__Create__ESD)");
	}
	return context;
}
