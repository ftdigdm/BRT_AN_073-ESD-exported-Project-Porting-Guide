...
ESD_WIDGET(Ft_Esd_CircularGradient, Include = "Ft_Esd_CircularGradient.h", Callback, DisplayName = "ESD Circular Gradient", Category = EsdBasicWidgets, X = 173, Y = 75, Width = 320, Height = 315)
typedef struct
{
	union
	{
