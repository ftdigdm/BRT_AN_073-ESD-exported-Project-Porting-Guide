...
void *Ft_Esd_Image__Create__ESD()
{
	...
	{
		eve_printf_debug("Out of memory (Ft_Esd_Image__Create__ESD)");
	}
	return context;
}
...
void Ft_Esd_Image__Set_Align__ESD(void *context, uint8_t value) { ((Ft_Esd_Image__ESD *)context)->Instance.Align = value; }
void Ft_Esd_Image__Set_Scaling__ESD(void *context, uint8_t value) { ((Ft_Esd_Image__ESD *)context)->Instance.Scaling = value; }
