...
void Ft_Esd_RenderForwarder__Initializer(Ft_Esd_RenderForwarder *context)
{
	...
	context->ForwardUpdate = Esd_Noop;
	context->ForwardRender = Esd_Noop;
	context->ForwardIdle = Esd_Noop;
}
...
void *Ft_Esd_RenderForwarder__Create__ESD()
{
	...
	{
		eve_printf_debug("Out of memory (Ft_Esd_RenderForwarder__Create__ESD)");
	}
	return context;
}
