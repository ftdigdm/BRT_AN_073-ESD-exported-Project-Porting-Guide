...
// TBD - Deprecate because it uses expensive SQRT at runtime
...
#define Ft_Esd_Render_RectangleF_Gradient Esd_Render_RectF_Grad
...
ESD_PARAMETER(color2, Type = ft_argb32_t, DisplayName = "color2", Default = #FFFFFFFF)
ESD_PARAMETER(direction, Type = ft_int16_t, DisplayName = "direction", Default = 90)
#define Ft_Esd_Render_Rectangle_Gradient Esd_Render_Rect_Grad
...
#define Ft_Esd_Render_RectangleF
