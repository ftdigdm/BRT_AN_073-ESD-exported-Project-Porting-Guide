...
ESD_RENDER(Ft_Gpu_CoCmd_Text, Type = ft_void_t, Category = _GroupHidden, Macro)
...
ESD_RENDER(Ft_Gpu_CoCmd_Text_Ex, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(x, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
ESD_PARAMETER(y, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
ESD_PARAMETER(font, Type = ft_int16_t, Default = 21, Min = 0, Max = 31) // BITMAP_HANDLE
...
ESD_RENDER(Ft_Gpu_CoCmd_Number, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(x, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
ESD_PARAMETER(y, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
...
ESD_FUNCTION(Ft_Gpu_CoCmd_LoadIdentity, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST

ESD_RENDER(Ft_Gpu_CoCmd_Toggle, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(x, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
ESD_PARAMETER(y, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
...
ESD_RENDER(Ft_Gpu_CoCmd_Gauge, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(x, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
ESD_PARAMETER(y, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
...
ESD_FUNCTION(Ft_Gpu_CoCmd_MemCpy, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
...
ESD_FUNCTION(Ft_Gpu_CoCmd_BgColor, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(c, Type = ft_rgb32_t, Default = 0) // COLOR

ESD_FUNCTION(Ft_Gpu_CoCmd_Translate, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(tx, Type = ft_int32_t, Default = 0)
ESD_PARAMETER(ty, Type = ft_int32_t, Default = 0)

ESD_FUNCTION(Ft_Gpu_CoCmd_SetBase, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(base, Type = ft_int32_t, Default = 0)

ESD_RENDER(Ft_Gpu_CoCmd_Slider, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(x, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
ESD_PARAMETER(y, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
ESD_PARAMETER(width, Type = ft_int16_t, Default = 60) // SCREEN_SIZE
...
ESD_FUNCTION(Ft_Gpu_CoCmd_Interrupt, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(ms, Type = ft_int32_t, Default = 0)

ESD_FUNCTION(Ft_Gpu_CoCmd_FgColor, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(c, Type = ft_rgb32_t, Default = 0) // COLOR

ESD_FUNCTION(Ft_Gpu_CoCmd_Rotate, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(a, Type = ft_int32_t, Default = 0)

ESD_RENDER(Ft_Gpu_CoCmd_Button, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(x, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
ESD_PARAMETER(y, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
ESD_PARAMETER(width, Type = ft_int16_t, Default = 60) // SCREEN_SIZE
...
ESD_RENDER(Ft_Gpu_CoCmd_Scrollbar, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(x, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
ESD_PARAMETER(y, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
ESD_PARAMETER(width, Type = ft_int16_t, Default = 60) // SCREEN_SIZE
...
ESD_FUNCTION(Ft_Gpu_CoCmd_MemSet, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(ptr, Type = ft_uint32_t, Default = 0) // MEMORY_ADDRESS
ESD_PARAMETER(value, Type = ft_uint32_t, Default = 0)
ESD_PARAMETER(num, Type = ft_uint32_t, Default = 0) // MEMORY_ADDRESS

ESD_FUNCTION(Ft_Gpu_CoCmd_BitmapTransform, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
...
ESD_FUNCTION(Ft_Gpu_CoCmd_GradColor, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(c, Type = ft_rgb32_t, Default = 0) // COLOR

ESD_FUNCTION(Ft_Gpu_CoCmd_Sync, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST

ESD_FUNCTION(Ft_Gpu_CoCmd_Append, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(ptr, Type = ft_uint32_t, Default = 0) // MEMORY_ADDRESS
ESD_PARAMETER(num, Type = ft_uint32_t, Default = 0, Min = 0, Max = 2048)

ESD_FUNCTION(Ft_Gpu_CoCmd_MemZero, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(ptr, Type = ft_uint32_t, Default = 0) // MEMORY_ADDRESS
ESD_PARAMETER(num, Type = ft_uint32_t, Default = 0) // MEMORY_ADDRESS

ESD_FUNCTION(Ft_Gpu_CoCmd_Scale, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(sx, Type = ft_int32_t, Default = 0)
ESD_PARAMETER(sy, Type = ft_int32_t, Default = 0)

ESD_RENDER(Ft_Gpu_CoCmd_Clock, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(x, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
ESD_PARAMETER(y, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
ESD_PARAMETER(r, Type = ft_int16_t, Default = 40) // SCREEN_SIZE
...
ESD_FUNCTION(Ft_Gpu_CoCmd_Gradient, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
...
ESD_FUNCTION(Ft_Gpu_CoCmd_SetMatrix, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST

ESD_RENDER(Ft_Gpu_CoCmd_Progress, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(x, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
ESD_PARAMETER(y, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
ESD_PARAMETER(width, Type = ft_int16_t, Default = 60) // SCREEN_SIZE
...
ESD_RENDER(Ft_Gpu_CoCmd_Keys, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(x, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
ESD_PARAMETER(y, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
ESD_PARAMETER(width, Type = ft_int16_t, Default = 60) // SCREEN_SIZE
...
ESD_RENDER(Ft_Gpu_CoCmd_Dial, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(x, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
ESD_PARAMETER(y, Type = ft_int16_t, Default = 0) // SCREEN_SIZE
ESD_PARAMETER(r, Type = ft_int16_t, Default = 40) // SCREEN_SIZE
...
ESD_FUNCTION(Ft_Esd_CoCmd_Spinner, Type = ft_void_t, Category = _GroupHidden, Macro)
...
ESD_FUNCTION(Ft_Esd_CoCmd_ScreenSaver, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(owner, Type = void *, Default = 0, Hidden, Internal)

ESD_FUNCTION(Ft_Esd_CoCmd_Sketch, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(owner, Type = void *, Default = 0, Hidden, Internal)
...
ESD_FUNCTION(Ft_Esd_CoCmd_Stop, Type = ft_void_t, Category = _GroupHidden, Macro)
ESD_PARAMETER(owner, Type = void *, Default = 0, Hidden, Internal)
