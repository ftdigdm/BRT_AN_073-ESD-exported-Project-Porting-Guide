...
static Ft_Esd_WidgetSlots s_Ft_Esd_Widget__NoopSlots = {
	(void (*)(void *))Esd_Noop,
	(void (*)(void *))Esd_Noop,
	(void (*)(void *))Esd_Noop,
	(void (*)(void *))Esd_Noop,
...
{
	// eve_printf_debug("Request free widget\n");
	if (context->Parent)
	{
#ifndef NDBEUG
	...
	context->Slots = &s_Ft_Esd_Widget__NoopSlots;
	Esd_DeferredFree(context);
}
