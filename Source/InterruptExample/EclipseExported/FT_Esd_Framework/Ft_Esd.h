...
#define FT_DispWidth Esd_GetHost()->Width
#define FT_DispHeight Esd_GetHost()->Height

#define Esd_DispWidth Esd_GetHost()->Width
#define Esd_DispHeight Esd_GetHost()->Height
