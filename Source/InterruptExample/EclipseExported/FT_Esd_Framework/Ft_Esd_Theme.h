...
ESD_FUNCTION(Ft_Esd_Theme_GetDefaultColor, DisplayName = "Get Default Color", Category = EsdTheme, Type = ft_rgb32_t, Include = "Ft_Esd_Theme.h", Icon = ":/icons/palette-paint-brush.png", Inline)
ESD_PARAMETER(theme, Type = Ft_Esd_Theme *, Default = Ft_Esd_Theme_GetCurrent)
inline static ft_rgb32_t Ft_Esd_Theme_GetDefaultColor(Ft_Esd_Theme *theme)
{
	if (!theme)
...
ESD_FUNCTION(Ft_Esd_Theme_GetCurrentColor, DisplayName = "Get Default Color", Category = _GroupHidden, Type = ft_rgb32_t, Include = "Ft_Esd_Theme.h", Icon = ":/icons/palette-paint-brush.png", Macro)
ESD_PARAMETER(theme, Type = Ft_Esd_Theme *, Default = Ft_Esd_Theme_GetCurrent)
